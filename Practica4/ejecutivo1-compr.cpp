...
int main( int argc, char *argv[] )
{
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         time_point < steady_clock > cicle_end = steady_clock::now() ;

         steady_clock::duration d = cicle_end - ini_sec ;

         cout << "El ciclo secundario ha durado: " << milliseconds_f(d).count() << " milliseconds. " << endl;
